                                    ...
                                    <ul class="list-unstyled" data-simplebar style="height: 360px">
                                        <li>
                                            <a href="javscript:void(0)"
                                                ...
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset('backend') }}/assets/img/user/u2.jpg"
                                                        alt="Image">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)"
                                                ...
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset('backend') }}/assets/img/user/u1.jpg"
                                                        alt="Image">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)"
                                                class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset('backend') }}/assets/img/user/u5.jpg"
                                                        alt="Image">
                                                    <span class="status away"></span>
                                                </div>
                                                <div class="media-body d-flex justify-content-between">
                                    ...
                                    <ul class="list-unstyled" data-simplebar style="height: 360px">
                                        <li>
                                            <a href="javscript:void(0)"
                                                class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset('backend') }}/assets/img/user/u6.jpg"
                                                        alt="Image">
                                                    <span class="status away"></span>
                                                </div>
                                                <div class="media-body d-flex justify-content-between">
                                        ...
                                        <li>
                                            <a href="javscript:void(0)"
                                                class="media media-message media-notification">
                                                <div class="position-relative mr-3">
                                                    <img class="rounded-circle" src="{{ asset('backend') }}/assets/img/user/u7.jpg"
                                                        alt="Image">
                                                    <span class="status away"></span>
                                                </div>
                                                <div class="media-body d-flex justify-content-between">

                                        ...
                                        <div class="ec-vendor-upload-detail">
                                            <div class="row g-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control slug-title" id="inputEmail4" name="title" placeholder="e.g:Kids Premium Water Bottle Sweet Pink" required>
                                                </div>
                                                <div class="col-md-12 mt-3">
                                                    <label for="slug" class="col-12 col-form-label">Slug <span class="red">*</span></label>
                                                    <div class="col-12">
                                                        <input id="productSlug" name="slug" class="form-control here set-slug" type="text" placeholder="e.g:kids-premium-water-bottle-sweet-pink" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 mt-3">
                                                    <label class="form-label">Code <span class="red">*</span></label>
                                                    <input type="text" class="form-control"
                                                        title="Product Code" name="code" placeholder="P-123" required>
                                                </div>
                                                <div class="col-md-3 mt-3">
                                                    <label class="form-label">Colors</label>
                                                    <input type="text" class="form-control"
                                                        title="Choose your color" placeholder="White">
                                                </div>
                                                ...
                                                <!-- <div class="col-md-4 mt-3">
                                                    ...
                                                    <input type="number" class="form-control" id="purchasePrice" placeholder="100" name="cost" required>
                                                </div> -->
                                                <div class="col-md-4 mt-3">
                                                    <label class="form-label">Price<span>( In BDT ) </span> <span class="red">*</span></label>
                                                    <input type="number" class="form-control" id="mrpPrice" required name="mrp" placeholder="150">
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                    <label class="form-label">Discount<span>( In BDT )</label>
                                                    <input type="number" class="form-control" id="discount_amount" name="discount_amount" placeholder="0">
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                ...
                                                <div class="col-md-4 mt-3">
                                                    ...
                                                    <input type="number" class="form-control" id="quantity1" required name="alert_stock" placeholder="10">
                                                </div>
                                                <div class="col-md-4 mt-3">
                                                ...
                                                <div class="col-md-12 mt-4 mb-4">
                                                    ...
                                                    <textarea class="form-control" rows="4" id="moreInfo" name="moreInfo"></textarea>
                                                </div>
                                                {{-- <div class="col-md-12">
